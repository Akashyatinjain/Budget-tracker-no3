 ...
 const handleLogout = () => {
  ...
  return (
    <header
      ...
      bg-[#0f0f0f]/90 backdrop-blur-md border-b border-purple-700/20 
  ...
  <img src={logo} alt="Logo" className="w-5 h-5 object-contain" />
        ...
        <div className="hidden md:block ml-4 pl-4 border-l border-gray-800">
          <h1 className="text-base font-medium text-purple-300">
            {getPageTitle()}
          </h1>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        {/* Notifications */}
        <button
          className="relative p-2 text-gray-300 hover:text-white hover:bg-gray-800 
          ...
          <>
            <div className="hidden md:flex items-center gap-3">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-md bg-gray-800 text-sm text-white font-medium 
                hover:bg-gray-700 transition-all duration-200"
              >
                <FaSignOutAlt className="inline-block mr-1 text-xs" />
                Logout
              </button>
            </div>

            {/* Mobile: Only Profile Icon (no logout here) */}
<Link
  to="/app/account"
  className="w-9 h-9 rounded-full bg-gradient-to-r from-purple-600 to-indigo-700 
             flex items-center justify-center hover:ring-2 hover:ring-purple-500/50 transition-all"
>
